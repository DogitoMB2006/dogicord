          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full p-4 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-600 disabled:cursor-not-allowed rounded-xl transition-colors text-left"
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-white font-medium">Create My Own</h3>
                    <p className="text-gray-400 text-sm">Create a new server from scratch</p>
                  </div>
                </div>
              </button>
            ...
            <div className="mt-6 pt-4 border-t border-gray-700">
              <button
                onClick={handleClose}
                disabled={loading}
                className="w-full py-2 text-gray-400 hover:text-white disabled:text-gray-500 transition-colors"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="p-6">
            <div className="mb-6">
              <button
                ...
                disabled={loading}
                className="text-slate-400 hover:text-white disabled:text-gray-500 mb-4"
              >
                ← Back
              </button>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                disabled={loading}
                className="w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 disabled:bg-gray-700 disabled:cursor-not-allowed"
                maxLength={50}
              />
